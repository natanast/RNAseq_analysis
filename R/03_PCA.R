...
df1 = "DESeq2/DESeq2_Group_M_vs_G.xlsx" |> 
    readxl::read_xlsx() |>
    setDT()
...
filtered_counts <- df2[which(Geneid %in% significant_genes)]


filtered_counts_df = filtered_counts |> transpose(make.names = "Geneid", keep.names = "Sample")
...
ggsave(
  plot = gr, filename = paste0("pca_M_vs_G.jpeg"), 
